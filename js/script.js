...
// Шаблон карточки с использованием синтаксиса шаблонных строк
const cardTemplate = (data) => `
<div class="application__item">
  <div class="application__item-header">
      <span>${data.city}</span>
      <svg width="25" height="26" viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M21.4167 4.57292C22.0312 5.1875 22.0312 6.17708 21.4167 6.78125L17.3646 10.8333L19.5729 20.4062L18.1042 21.8854L14.0625 14.1458L9.99999 18.2083L10.375 20.7812L9.26041 21.8854L7.42707 18.5729L4.10416 16.7292L5.20832 15.6042L7.81249 15.9896L11.8437 11.9583L4.10416 7.88542L5.58332 6.41667L15.1562 8.625L19.2083 4.57292C19.7917 3.96875 20.8333 3.96875 21.4167 4.57292Z" fill="#741ADE"/>
      </svg>
      <span>${data.country}</span>    
  </div>
  <div class="application__item-row">
      <div class="application__item-block">
          ...
          <div class="application__item-col">
              <span><b>${data.data}</b></span>
              <span>от ${data.nightFirst} до ${data.nightSecond} ноч.</span>
          </div>
      </div>
      ...
      <div class="application__item-block">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M9.15962 11.62C9.12962 11.62 9.10962 11.62 9.07962 11.62C9.02962 11.61 8.95962 11.61 8.89962 11.62C5.99962 11.53 3.80962 9.25 3.80962 6.44C3.80962 3.58 6.13962 1.25 8.99962 1.25C11.8596 1.25 14.1896 3.58 14.1896 6.44C14.1796 9.25 11.9796 11.53 9.18962 11.62C9.17962 11.62 9.16962 11.62 9.15962 11.62ZM8.99962 2.75C6.96962 2.75 5.30962 4.41 5.30962 6.44C5.30962 8.44 6.86962 10.05 8.85962 10.12C8.91962 10.11 9.04962 10.11 9.17962 10.12C11.1396 10.03 12.6796 8.42 12.6896 6.44C12.6896 4.41 11.0296 2.75 8.99962 2.75Z" fill="#0F0C39"/>
              <path d="M16.5396 11.75C16.5096 11.75 16.4796 11.75 16.4496 11.74C16.0396 11.78 15.6196 11.49 15.5796 11.08C15.5396 10.67 15.7896 10.3 16.1996 10.25C16.3196 10.24 16.4496 10.24 16.5596 10.24C18.0196 10.16 19.1596 8.96 19.1596 7.49C19.1596 5.97 17.9296 4.74 16.4096 4.74C15.9996 4.75 15.6596 4.41 15.6596 4C15.6596 3.59 15.9996 3.25 16.4096 3.25C18.7496 3.25 20.6596 5.16 20.6596 7.5C20.6596 9.8 18.8596 11.66 16.5696 11.75C16.5596 11.75 16.5496 11.75 16.5396 11.75Z" fill="#0F0C39"/>
              <path d="M9.16961 22.55C7.20961 22.55 5.23961 22.05 3.74961 21.05C2.35961 20.13 1.59961 18.87 1.59961 17.5C1.59961 16.13 2.35961 14.86 3.74961 13.93C6.74961 11.94 11.6096 11.94 14.5896 13.93C15.9696 14.85 16.7396 16.11 16.7396 17.48C16.7396 18.85 15.9796 20.12 14.5896 21.05C13.0896 22.05 11.1296 22.55 9.16961 22.55ZM4.57961 15.19C3.61961 15.83 3.09961 16.65 3.09961 17.51C3.09961 18.36 3.62961 19.18 4.57961 19.81C7.06961 21.48 11.2696 21.48 13.7596 19.81C14.7196 19.17 15.2396 18.35 15.2396 17.49C15.2396 16.64 14.7096 15.82 13.7596 15.19C11.2696 13.53 7.06961 13.53 4.57961 15.19Z" fill="#0F0C39"/>
              <path d="M18.3396 20.75C17.9896 20.75 17.6796 20.51 17.6096 20.15C17.5296 19.74 17.7896 19.35 18.1896 19.26C18.8196 19.13 19.3996 18.88 19.8496 18.53C20.4196 18.1 20.7296 17.56 20.7296 16.99C20.7296 16.42 20.4196 15.88 19.8596 15.46C19.4196 15.12 18.8696 14.88 18.2196 14.73C17.8196 14.64 17.5596 14.24 17.6496 13.83C17.7396 13.43 18.1396 13.17 18.5496 13.26C19.4096 13.45 20.1596 13.79 20.7696 14.26C21.6996 14.96 22.2296 15.95 22.2296 16.99C22.2296 18.03 21.6896 19.02 20.7596 19.73C20.1396 20.21 19.3596 20.56 18.4996 20.73C18.4396 20.75 18.3896 20.75 18.3396 20.75Z" fill="#0F0C39"/>
          </svg>
          
          <div class="application__item-col">
              <span><b>${data.tourists_count} туриста</b></span>
              <span>${data.tourists_count} взрослых</span>
          </div>
      </div>
  </div>
  <div class="application__item-row second-row">
      <p>Предложений по заявке:</p>
      <span>Нет</span>
  </div>

  <div class="application__item-button" onclick="window.location.href='detail_page.html?id=${data.key}';">Ответить на заявку</div>
</div>
`;

// Функция для получения данных из Firebase и обновления HTML
function updateApplicationItems() {
  // Получаем ссылку на элемент, куда будем добавлять данные
  var applicationItemsElement = document.querySelector('.application__items');

  // Создаем новый элемент div для каждой заявки
  db.ref('Order').once('value').then(function(snapshot) {
      snapshot.forEach(function(childSnapshot) {
          var childData = childSnapshot.val();
          var childKey = childSnapshot.key;
          // var newCard = cardTemplate(childData);
          var newCard = cardTemplate({...childData, key: childKey }); 

          // Добавляем новую заявку в список
          applicationItemsElement.innerHTML += newCard;
      });
  });
}

// Вызываем функцию для обновления списка заявок при загрузке страницы
